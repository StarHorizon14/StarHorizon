...
alerts-walking-desc = Вы идете, двигаетесь в медленном темпе.
...
alerts-knockdown-desc = Вы [color=yellow]сбиты с ног[/color]! Что-то сбило вас или вы поскользнулись, ограничивая вашу подвижность.
...
alerts-vow-broken-desc = Вы нарушили свою клятву, данную Мимам. Вы можете говорить, но вы потеряли свои силы, как минимум, на целых 5 минут!!! Нажмите, чтобы попытаться повторить свою клятву.
...
alerts-adrenaline-desc = Вы полны адреналина: боль вас не остановит.
