...
shipyard-console-no-cash = Вставьте наличные для оплаты корабля.
shipyard-console-insufficient-cash = Недостаточно наличных средств. Стоимость: { $cost } кредитов.
shipyard-console-cash-slot-label = Вставлено наличных:{ " " }
...
shipyard-console-menu-sortby-label = Сортировка:{ " " }
...
shipyard-console-rename-button = Переменовать
shipyard-console-rename-placeholder = Имя шаттла
...
shipyard-console-sortby-Name = Имя
shipyard-console-sortby-Price = Цена
