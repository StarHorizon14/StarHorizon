...
lathe-menu-reagent-slot-examine = Сбоку имеется разъем для мензурки.
...
lathe-menu-delete-fabricating-tooltip = Отменить печать предмета.
lathe-menu-delete-item-tooltip = Отменить печать партии.
