...
shipyard-console-no-cash = Insert cash to pay for the ship.
shipyard-console-insufficient-cash = Insufficient cash inserted. Cost: {$cost} credits.
shipyard-console-cash-slot-label = Cash inserted:{" "}
