...
ent-BaseUplinkRadio60TC = { ent-BaseUplinkRadio }
    ...
    .desc = { ent-BaseUplinkRadio.desc }
ent-OperativeUplinkRadio25TC = { ent-BaseUplinkRadio }
    .suffix = 25 TC, Operative
    .desc = { ent-BaseUplinkRadio.desc }
ent-TelecomOfficerUplinkRadio60TC = { ent-BaseUplinkRadio }
    .suffix = 60 TC, TelecomOfficer
    .desc = { ent-BaseUplinkRadio.desc }
