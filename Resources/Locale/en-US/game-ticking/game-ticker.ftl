...
game-ticker-player-spawn-no-valid-location = Could not place you at your selected station (it may no longer be there). The job slot was not used — try another role or wait for the crew to return.
